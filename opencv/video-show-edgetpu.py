...
model = YOLO("yolov8n_saved_model/yolov8n_full_integer_quant_edgetpu.tflite")  # Ensure you use the correct path to your .tflite model
...
while True:
    ...
    # Perform inference using the EdgeTPU model
    results = model.predict(frame)  # Use the frame as input for prediction
