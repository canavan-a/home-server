              ...
              <div className="text-center w-full flex flex-col items-center justify-center space-y-6">
                <div className="relative inline-flex items-center justify-center">
                  ...
                  {isToggling ? (
                    ...
                    <svg className={isPending ? "opacity-30" : ""} width="200px" height="200px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className={isPending ? "opacity-30" : ""} width="200" height="200px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
